...
local Fz = {
		...
		["Logo Image"] = "rbxassetid://112138339888922",
...
gz.Image = "rbxassetid://112138339888922";
...
function Kz.CreateMain(Y)
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">Tày Hub </font> : Blox Fruits [Premium]");
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">Tày Hub </font> : Blox Fruits [Premium]");
	K.Name = "Background1";
	K.Parent = g;
